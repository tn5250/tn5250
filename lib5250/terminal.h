...
struct _Tn5250Terminal {
    ...
    void (*putkey)(struct _Tn5250Terminal* This, struct _Tn5250Display* display,
                   unsigned char key, int row, int column);
    void (*beep)(struct _Tn5250Terminal* This);
    int (*enhanced)(struct _Tn5250Terminal* This);
    int (*config)(struct _Tn5250Terminal* This, struct _Tn5250Config* config);
...
extern void tn5250_terminal_putkey(Tn5250Terminal* This,
                                   struct _Tn5250Display* d, unsigned char k,
                                   int y, int x);
