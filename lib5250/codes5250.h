...
#define MSG_BYPASS_FIELD                                                       \
    "Entry of data not allowed in this "                                       \
    "input/output field."
#define MSG_NO_FIELD "Cursor in protected area of display."
#define MSG_INVALID_SYSREQ                                                     \
    "Key pressed following System Request "                                    \
    "key was not valid."
#define MSG_MANDATORY_ENTRY                                                    \
    "Mandatory data entry field. "                                             \
...
#define MSG_DUP_NOT_ENABLED                                                    \
    "Duplicate key or Field Mark key not "                                     \
    "allowed in field."
