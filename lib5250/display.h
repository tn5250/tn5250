...
extern struct _Tn5250Field* tn5250_display_field_at(Tn5250Display* This, int y,
                                                    int x);
...
extern void tn5250_display_shift_right(Tn5250Display* This, Tn5250Field* field,
                                       unsigned char fill);
...
extern void tn5250_display_do_aidkey(Tn5250Display* This, int aidcode);
...
extern void tn5250_display_set_pending_insert(Tn5250Display* This, int y,
                                              int x);
...
extern void tn5250_display_set_msg_line(Tn5250Display* This,
                                        const unsigned char* m, int msglen);
extern void tn5250_display_set_char_map(Tn5250Display* This, const char* name);
...
extern void tn5250_display_kf_macro(Tn5250Display* This, int Ch);
...
#define tn5250_display_dbuffer(This)    ((This)->display_buffers)
#define tn5250_display_indicators(This) ((This)->indicators)
...
#define tn5250_display_pending_insert(This) ((This)->pending_insert)
...
#define tn5250_display_char_map(This) ((This)->map)
