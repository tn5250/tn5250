...
#define tn5250_field_mdt(This) (((This)->FFW & TN5250_FIELD_MODIFIED) != 0)
#define tn5250_field_clear_mdt(This)                                           \
    (void)((This)->FFW &= ~TN5250_FIELD_MODIFIED)
#define tn5250_field_is_bypass(This) (((This)->FFW & TN5250_FIELD_BYPASS) != 0)
...
#define tn5250_field_is_fer(This) (((This)->FFW & TN5250_FIELD_FER) != 0)
...
#define tn5250_field_is_mand_fill(This) (tn5250_field_mand_fill_type(This) != 0)

#define tn5250_field_type(This) ((This)->FFW & TN5250_FIELD_FIELD_MASK)
...
#define tn5250_field_control(This) ((This)->FCW)
#define tn5250_field_is_higlighted_entry(This)                                 \
    ((tn5250_field_control(This) & 0xFF00) ==                                  \
     TN5250_FIELD_CONTROL_HILIGHTED_ENTRY)
#define tn5250_field_is_continued(This)        ((This)->continuous)
#define tn5250_field_is_continued_first(This)  ((This)->continued_first)
#define tn5250_field_is_continued_middle(This) ((This)->continued_middle)
#define tn5250_field_is_continued_last(This)   ((This)->continued_last)
#define tn5250_field_is_wordwrap(This)         ((This)->wordwrap)

#define tn5250_field_attribute(This) ((This)->attribute)
#define tn5250_field_start_row(This) ((This)->start_row)
#define tn5250_field_start_col(This) ((This)->start_col)
#define tn5250_field_length(This)    ((This)->length)
...
tn5250_field_list_destroy(Tn5250Field /*@null@*/ /*@only@*/* list);
extern Tn5250Field* tn5250_field_list_add(Tn5250Field /*@null@*/* list,
                                          Tn5250Field /*@dependent@*/* node);
extern Tn5250Field /*@null@*/*
...
extern Tn5250Field /*@null@*/*
tn5250_field_list_copy(Tn5250Field /*@null@*/* list);
