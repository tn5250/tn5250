...
Tn5250Menubar* tn5250_menubar_new() {
...
Tn5250Menubar* tn5250_menubar_copy(Tn5250Menubar* This) {
...
void tn5250_menubar_destroy(Tn5250Menubar* This) { free(This); }

Tn5250Menubar* tn5250_menubar_list_destroy(Tn5250Menubar* list) {
...
Tn5250Menubar* tn5250_menubar_list_add(Tn5250Menubar* list,
                                       Tn5250Menubar* node) {
...
Tn5250Menubar* tn5250_menubar_list_remove(Tn5250Menubar* list,
                                          Tn5250Menubar* node) {
    if (list == NULL) {
        return NULL;
    }
...
Tn5250Menubar* tn5250_menubar_list_find_by_id(Tn5250Menubar* list, int id) {
    Tn5250Menubar* iter;
...
Tn5250Menubar* tn5250_menubar_list_copy(Tn5250Menubar* This) {
...
Tn5250Menubar* tn5250_menubar_hit_test(Tn5250Menubar* list, int x, int y) {
    Tn5250Menubar* iter;
...
void tn5250_menubar_select_next(Tn5250Menubar* This, int* x, int* y) {
...
void tn5250_menubar_select_prev(Tn5250Menubar* This, int* x, int* y) {
    Tn5250Menuitem* menuitem =
        tn5250_menuitem_hit_test(This->menuitem_list, *x, *y);
 ...
 *    DOCUMENT ME!!!
 *****/
void tn5250_menu_add_menuitem(Tn5250Menubar* This, Tn5250Menuitem* menuitem) {
    menuitem->id = This->menuitem_count++;
    menuitem->menubar = This;
    This->menuitem_list =
        tn5250_menuitem_list_add(This->menuitem_list, menuitem);

    TN5250_LOG(("adding menu item: menuitem->id: %d\n", menuitem->id));
    return;
}

Tn5250Menuitem* tn5250_menuitem_new() {
...
Tn5250Menuitem* tn5250_menuitem_list_add(Tn5250Menuitem* list,
                                         Tn5250Menuitem* node) {
    node->prev = node->next = NULL;
...
Tn5250Menuitem* tn5250_menuitem_list_remove(Tn5250Menuitem* list,
                                            Tn5250Menuitem* node) {
    if (list == NULL) {
        return NULL;
    }
...
int tn5250_menuitem_new_row(Tn5250Menuitem* This) {
...
int tn5250_menuitem_new_col(Tn5250Menuitem* This) {
    unsigned char menutype = tn5250_menubar_type(This->menubar);
...
Tn5250Menuitem* tn5250_menuitem_list_find_by_id(Tn5250Menuitem* list, int id) {
    Tn5250Menuitem* iter;
...
Tn5250Menuitem* tn5250_menuitem_hit_test(Tn5250Menuitem* list, int x, int y) {
    Tn5250Menuitem* iter;
