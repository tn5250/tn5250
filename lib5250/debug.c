...
static void debug_terminal_update_indicators(Tn5250Terminal* This,
 ...
 *    DOCUMENT ME!!!
 *****/
Tn5250Terminal* tn5250_debug_terminal_new(Tn5250Terminal* slave,
                                          Tn5250Stream* dbgstream) {
 ...
 *    DOCUMENT ME!!!
 *****/
static int debug_stream_handle_receive(Tn5250Stream* This) { return 1; }
 ...
 *    DOCUMENT ME!!!
 *****/
static void debug_stream_destroy(Tn5250Stream* This) { /* noop */
}
 ...
 *    DOCUMENT ME!!!
 *****/
static void debug_terminal_update(Tn5250Terminal* This,
                                  Tn5250Display* display) {
...
static void debug_terminal_update_indicators(Tn5250Terminal* This,
                                             Tn5250Display* display) {
    (*(This->data->slaveterm->update_indicators))(This->data->slaveterm,
                                                  display);
}
    ...
    while (fgets(buf, sizeof(buf) - 2, This->data->dbgstream->debugfile)) {
        ...
        if (!memcmp(buf, "@record ", 8)) {
            ...
            for (n = 14; n < 49; n += 2) {
                ...
                b = (isdigit(buf[n]) ? (buf[n] - '0')
                                     : (tolower(buf[n]) - 'a' + 10))
                    << 4;
                b |= (isdigit(buf[n + 1]) ? (buf[n + 1] - '0')
                                          : (tolower(buf[n + 1]) - 'a' + 10));
                tn5250_record_append_byte(This->data->dbgstream->current_record,
                                          b);
            }
        }
            ...
            if (This->data->dbgstream->records == NULL) {
                ...
                This->data->dbgstream->current_record->next =
                    This->data->dbgstream->records;
                This->data->dbgstream->current_record->prev =
                    This->data->dbgstream->records->prev;
                This->data->dbgstream->current_record->next->prev =
                    This->data->dbgstream->current_record;
                This->data->dbgstream->current_record->prev->next =
                    This->data->dbgstream->current_record;
            }
