...
/* Displays */
extern Tn5250DBuffer /*@only@ */ /*@null@ */* tn5250_dbuffer_new(int width,
                                                                 int height);
...
extern struct _Tn5250Field* tn5250_dbuffer_field_yx(Tn5250DBuffer* This, int y,
                                                    int x);
