...
#define MENU_TYPE_MULTIPLE_SELECT_FIELD                                        \
    0x12                                  /* Multiple choice selection field */
#define MENU_TYPE_SINGLE_SELECT_LIST 0x21 /* Single choice selection list */
#define MENU_TYPE_MULTIPLE_SELECT_LIST                                         \
    0x22 /* Multiple choice selection list                                     \
          */
#define MENU_TYPE_SINGLE_SELECT_FIELD_PULL_DOWN                                \
    0x31 /* Single choice selection field and a pull-down list */
#define MENU_TYPE_MULTIPLE_SELECT_FIELD_PULL_DOWN                              \
    0x32 /* Multiple choice selection field and a pull-down list */
#define MENU_TYPE_PUSH_BUTTONS 0x41 /* Push buttons */
#define MENU_TYPE_PUSH_BUTTONS_PULL_DOWN                                       \
    0x51 /* Push buttons in a pull-down menu */
...
extern void tn5250_menubar_select_next(Tn5250Menubar* This, int* x, int* y);
extern void tn5250_menubar_select_prev(Tn5250Menubar* This, int* x, int* y);
...
extern Tn5250Menuitem* tn5250_menuitem_list_remove(Tn5250Menuitem* list,
                                                   Tn5250Menuitem* node);
extern Tn5250Menuitem* tn5250_menuitem_list_find_by_id(Tn5250Menuitem* list,
                                                       int id);
extern Tn5250Menuitem* tn5250_menuitem_list_copy(Tn5250Menuitem* list);
extern Tn5250Menuitem* tn5250_menuitem_hit_test(Tn5250Menuitem* list, int x,
                                                int y);
